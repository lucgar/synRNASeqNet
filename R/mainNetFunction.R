...
function(counts, adjMat, nchips, plotPath = "", tfList = NULL){
  ...
  plot(valML[, "FPR"], valML[, "Recall"], type = "l", col = ccol[1], xlab = "FP rate", ylab = "TP rate", main = "ROC Curve", xlim = 0:1, ylim = 0:1)
  lines(valMM[, "FPR"], valMM[, "Recall"], type = "l", col = ccol[2])
  lines(valBJ[, "FPR"], valBJ[, "Recall"], type = "l", col = ccol[3])
  lines(valBB[, "FPR"], valBB[, "Recall"], type = "l", col = ccol[4])
  lines(valBP[, "FPR"], valBP[, "Recall"], type = "l", col = ccol[5])
  lines(valBM[, "FPR"], valBM[, "Recall"], type = "l", col = ccol[6])
  lines(valCS[, "FPR"], valCS[, "Recall"], type = "l", col = ccol[7])
  lines(valSH[, "FPR"], valSH[, "Recall"], type = "l", col = ccol[8])
  lines(valKD[, "FPR"], valKD[, "Recall"], type = "l", col = ccol[9])
  lines(valKNN[, "FPR"], valKNN[, "Recall"], type = "l", col = ccol[10])
  ...
  ccol <- c("red", "blue", "green", "black", "gray", "yellow", "aquamarine3", "darkmagenta", "burlywood4", "orange")
  plot(valML[, "Recall"], valML[, "Precision"], type = "l", col = ccol[1], xlab = "recall", ylab = "precision", main = "PR Curve", xlim = 0:1, ylim = 0:1)
  lines(valMM[, "Recall"], valMM[, "Precision"], type = "l", col = ccol[2])
  lines(valBJ[, "Recall"], valBJ[, "Precision"], type = "l", col = ccol[3])
  lines(valBB[, "Recall"], valBB[, "Precision"], type = "l", col = ccol[4])
  lines(valBP[, "Recall"], valBP[, "Precision"], type = "l", col = ccol[5])
  lines(valBM[, "Recall"], valBM[, "Precision"], type = "l", col = ccol[6])
  lines(valCS[, "Recall"], valCS[, "Precision"], type = "l", col = ccol[7])
  lines(valSH[, "Recall"], valSH[, "Precision"], type = "l", col = ccol[8])
  lines(valKD[, "Recall"], valKD[, "Precision"], type = "l", col = ccol[9])
  lines(valKNN[, "Recall"], valKNN[, "Precision"], type = "l", col = ccol[10])
